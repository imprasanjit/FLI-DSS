    ...
    <body id="page-top" class="form">
                                        ...
                                        <div class="form-content">
                                            ...
                                            <form class="text-left" method="POST" action="/login" >
                                                <div class="alert alert-success">
                                                    We have sent the password to your registered mail.
                                                 </div >
        ...
        <section class="page-section" id="about">
            <div class="container">
                ...
                <p>Availability of location service enabled comprehensive forest land information for all types of Forest lands in the state. FLI-DSS involves comprehensive coverage of all kinds of Forest lands in the state 
...
Systematic generation of DSS reports on involvement of Forest land, ESZ, National Park, Sanctuary boundary etc. in targeted AoI to facilitate administrative decisions on proposed developmental projects.<p>
                </div>
        </section>
