            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="/fileUpload/UserManualFLIDSS.pdf" class='dropdown-item' target='_blank'>User manual</a></li>
                    </ul>
                </div>
            </div>
        </nav>
                                ...
                                <div class="form-form-wrap">
                                    <div class="form-container">
                                        <div class="form-content">
                                           ...
                                           <form method="post" action="/login" cssClass="text-left">
                                                ...
                                                <div class="form">
                                                   ...
                                                   <!--  <div class="field-wrapper mt-3 mb-3">
                                                    ...
                                                    <div class="field-wrapper text-center">
                                                        <button  type="button" class="btn btn-success" value="">Verify</button>
                                                    </div>
 -->
                                                </div>
                                            </form>                        
        ...
        <section class="page-section" id="about">
            <div class="container">
                <div class="text-center">
                    ...
                    <h7>Availability of location service enabled comprehensive forest land information for all types of Forest lands in the state. FLI-DSS involves comprehensive coverage of all kinds of Forest lands in the state 
                    such as Notified Forests, DLC & Revenue Forests, Deemed Forests, Diverted Forest lands, Protected areas, Sanctuaries, ESZ and wildlife corridors etc. 
It is a map based Analysis of Forest land data layers integrated with map data sources such as SoI, FSI and HRSI Ortho imagery etc. for generation of decision support inferences on Conservation, Protection, Change Assessment and Forests Management FLI-DSS shall facilitate dissemination of map based, location centric forest land information, data analytics and reporting to assist the Field Officials as well as Decision makers in efficient decision making. 
AoI based map analysis for decision on appropriate Forestry intervention for reducing forest degradation and enhancing growth.
Systematic generation of DSS reports on involvement of Forest land, ESZ, National Park, Sanctuary boundary etc. in targeted AoI to facilitate administrative decisions on proposed developmental projects.</h7>
				<!-- <a href='/fileUpload/UserManualFLIDSS.pdf' class='dropdown-item' target='_blank'>
				                  <i class="fa fa-file-pdf-o" style="font-size:40px;color:red">&nbsp;</i> <br><strong>Open user manual</strong></a>  -->			                     
                </div>
            ...
            <div class="container">
                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3741.718095366025!2d85.81722111484218!3d20.311932486391008!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a1909ba3c41165d%3A0x875f4d1794031e42!2sOdisha%20Forest%20Head%20Quarter%20(HQ)%2C%20PCCF%20Office!5e0!3m2!1sen!2sin!4v1655961013810!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body map-info">
                                <p>
                                  ...
                                  <strong>Address :</strong><br>The principal CCF & HoFF, Odisha, Aranya Bhawan, Chandrasekhapur Bhubneswer-751023
                                </p>
                                <p>
                                    <i class="info fa fa-phone">&nbsp;</i>
                                    <strong>Contact : </strong>0674-2602251
                                </p>
<%--                                 <p>
        ...
        <footer class="footer py-4">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-lg-4 text-lg-left">&copy; 2021. FLI-DSS. All Rights Reserved</div>
                                        ...
                                        <div class="form-form-wrap">
                                            <div class="form-container">
                                                <div class="form-content">
                                                    ...
                                                    <form class="text-left"  method="POST" action="/login_user">
                                                        <div class="form">

                                                            <div id="" class="field-wrapper input">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-mail"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                                                                <input id="" name="email" type="email" class="form-control" placeholder="Enter Emai ID">
                                                            </div>
