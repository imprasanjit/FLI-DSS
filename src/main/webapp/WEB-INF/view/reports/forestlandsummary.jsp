                                    ...
                                    <div id='right-defaults' class='dragula widget-header'>
                                        ...
                                        <div class="media  d-md-flex d-block text-sm-left text-center">                                            
                                            <div class="media-body">
                                                <div class="d-xl-flex d-block justify-content-between">
                                                    <div class="" >
                                                        <h6 class="fields" id="resDivName">Division Name</h6>  
                                        ...
                                        <div class="media  d-md-flex d-block text-sm-left text-center">                                            
                                            <div class="media-body">
                                                <div class="d-xl-flex d-block justify-content-between">
                                                    <div class="" >
                                                        <h6 class="fields" id="resRangeName">Range Name</h6>  
...
<script type="text/javascript">
	...
	function generateReport_click() {	
        ...
        range_code = ($("#drpRngList").val() == null || $("#drpRngList").val() == "") ? null : $("#drpRngList").val();
		 ...
		 $.ajax({
	            ...
	            success: function(result) {
	            	...
	            	if(isGenReport){
	            		...
	            		var v="/forestlanddetailsreport/filedownforestlanddetailsreport/"+'${userID}'+"ForestLandTypeDetails.pdf";
	            		window.open(v);
	            	}
	            },
	            error: function(errormessage) {
