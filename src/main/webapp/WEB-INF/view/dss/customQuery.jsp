					...
					<div class="widget-content widget-content-area">
						...
						<form >
							...
							<div class="text-center" style="margin-top:27px">
									...
									<button type="button" id="btnReset" class="btn btn-warning" onclick="location.href = '/DSS/customQuery';" >Reset</button>
								</div>
						</form>
...
$(document).ready(function() {
 ...
 <script type="text/javascript">
  ...
  $(document).ready(function() {
	...
	$(".header-title-lg").text(" ODISHA FLI-DSS (Custom Query)");
	$("#tehDiv").hide();
...
if ((div == '' || dst=='') && flt == ''){
...

    {
        ...
        /*  divname = $("#drpDivision option:selected").text();
         distname = $("#drpDistrict option:selected").text();
         rangename = $("#drpRngList option:selected").text(); */
