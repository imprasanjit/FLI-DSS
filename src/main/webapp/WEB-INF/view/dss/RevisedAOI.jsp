																	...
																	<div class="col-md-12">
																		<div
																			...
																			<label class="custom-control-label" for="chkState">State
																				Boundary</label> <img
																				src="http://103.112.26.243:8080/geoserver/FLI_DSS_STATE/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&LAYER=FLI_DSS_STATE:StateBoundary"
																				class="img-chk2" />
																		</div>
																		<div
																			class="custom-control custom-checkbox checkbox-info ml-2 mr-2">
																			...
																			<img
																				src="http://103.112.26.243:8080/geoserver/FLI_DSS_AllDivision/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&LAYER=FLI_DSS_AllDivision:district_boundary"
																				class="img-chk2" />
																		</div>
																		<div
																			class="custom-control custom-checkbox checkbox-info ml-2 mr-2">
																			<input type="checkbox"
																				...
																				Boundary</label> <img
																				src="http://103.112.26.243:8080/geoserver/FLI_DSS_Angul_vector/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&LAYER=FLI_DSS_Angul_vector:division_boundary"
																				class="img-chk2" />
																		</div>
																		<div
																			class="custom-control custom-checkbox checkbox-info ml-2 mr-2">
																			...
																			<img
																				src="http://103.112.26.243:8080/geoserver/FLI_DSS_Angul_vector/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&LAYER=FLI_DSS_Angul_vector:range_boundary"
																				class="img-chk2" />
																		</div>
																		<div
																			class="custom-control custom-checkbox checkbox-info ml-2 mr-2">
																			...
																			<img
																				src="http://103.112.26.243:8080/geoserver/FLI_DSS_Angul_vector/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&LAYER=FLI_DSS_Angul_vector:tahasil_boundary"
																				class="img-chk2" />
																		</div>
																		<!-- <div class="custom-control custom-checkbox checkbox-info ml-2 mr-2">
																		...
																		<div
																			...
																			<img
																				src="http://103.112.26.243:8080/geoserver/FLI_DSS_phulbani_vector/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&LAYER=FLI_DSS_phulbani_vector:village_boundary"
																				class="img-chk2" />
																		</div>
																		<div
																			class="custom-control custom-checkbox checkbox-info ml-2 mr-2">
