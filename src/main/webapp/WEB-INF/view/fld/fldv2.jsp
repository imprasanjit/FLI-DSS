	...
	$.ajax({
        ...
        success: function(data) {
        	...
        	/* } */
				...
				$("#totalRevForestTeh").text((revForestArea).toFixed(2)+' Acre');
                $("#totalDlcForestTeh").text((DlcForest+Common).toFixed(2)+' Acre');
				$("#totalBothTeh").text(Common.toFixed(2)+' Acre');
				$("#totalRecordedForestTeh").text((revForestArea+DlcForest+Common).toFixed(2)+' Acre');
	...
	$.ajax({
        ...
        success: function(data) {
        	...
        	/* } */
                ...
                $("#totalDlcForestVill").text((DlcForest+Common).toFixed(2)+' Acre');
