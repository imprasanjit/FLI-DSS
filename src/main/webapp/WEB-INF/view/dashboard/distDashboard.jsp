							...
							<div class="w-info">
								...
								<div class="row">
									<div class="col-md-3 border-right">
										<p class="text-white">
											<b>Target</b><br> <small>No. of NFB:</small> <span
												id="trgNfbNo"></span> <br> <small>Area(Km<sup>2</sup>):
									...
									<div class="col-md-4 border-right">
										<div class="bg-info dash-round">
											<p class="text-white">
												...
												</b><br> <small>No. of Plots: <span
													id="achvDLCPlots"></span> <br>Area(Km<sup>2</sup>):
										...
										<div class="bg-warning dash-round">
											<p class="text-white">
												<b>Achievement<br>(Revenue Forest)
													...
													id="achvRfPlots"></span> <br>Area(Km<sup>2</sup>):
							...
							<div class="w-info">
								...
								<div class="row">
									<div class="col-md-6 border-right">
										<p class="text-white">
											<b>Target</b><br> <small>Area(Km<sup>2</sup>): <span
												id="trgDeemed"></span></small><span id="trgDeemed"></span>
										</p>
					...
					<div class="widget-header">
						<div class="row">
							...
							<div class="col-xl-12 col-md-12 col-sm-12 col-12">
								...
								<figure class="highcharts-figure">
									<div id="containers11" style="height:calc(100vh - 330px)"></div>
								</figure>
							</div>
							<!-- <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                <h4>Geo-referencing of  Forest Land</h4>   
...
function getTargtAchv(){
	...
	$.ajax({
        async:true,
    	url: '/DistDashboard/getTargetAchv',
    ...
    $("#containers11").highcharts({
     ...
     lang: {
		...
		title: {
	      ...
	      subtitle: {
	        text: "Division wise Forest Land Area"
	      },
		  xAxis: {
			  type: 'category',
