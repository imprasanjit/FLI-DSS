										...
										<td class='text-center'>
											...
											<div class='btn-group' role='group'>
												...
												<a href='#' class="dropdown-item"  id="btnView" onclick="ViewDetails(${item.intId});"><i class="fa fa-info">&nbsp;</i>View Pillar Details</a>
														...
														<a href="/projectDocs/download/frjvc/${item.intFkDivision}/${item.chrvFkRangeCd}/${item.chrvFkRangeCd}-${item.intId}-JVR.pdf" target="_balnk" class="dropdown-item"><i class="fa fa-file-pdf-o" style='color:red'>&nbsp;</i>FRJVC Report</a>
												</div>
											</div>
