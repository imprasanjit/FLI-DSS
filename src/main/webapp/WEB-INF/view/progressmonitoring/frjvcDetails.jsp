				...
				<div class="statbox widget box box-shadow">
					...
					<div class="widget-content widget-content-area">
						...
						<form >
							...
							<div class="col-md- mb-2" style="display: none;">		
								...
								<div class="col-md-3 mb-2" id="divsnDiv" >
								...
								<div class="col-md-3 mb-2" id="ranDiv">
									<label>Range</label>
									<!-- <select class="form-control form-control-sm"> 
							...
							<div class="text-center" style="margin-top:27px">
								...
								<!-- <button type="reset" id="btnSearch" class="btn btn-warning"  >Reset</button> -->
							</div>
...
<!-- Modal -->
                                   ...
                                   <tr id="faqs-row0">
                                       <td width="40%">
                                           ...
                                           <select id="ddlQbFields1" class="form-control form-control-sm">
                                           	   <option selected="selected" value="">-- Select --</option>
                                           	   <!-- <option value="nareaha">Notified Aera(Ha.)</option> -->
                                           	   <option value="jvHa">JV Area(Ha.)</option>
                                           </select>
                                       </td>
                                       <td width="30%">
 ...
 <script type="text/javascript">
  ...
  $(document).ready(function() {
		// 	 setSelectedtext();
	  $("#tehDiv").hide();
	  $(".header-title-lg").text("ODISHA FLI-DSS (FRJVC Details)");
 	});
...
if ((div == '' || dst=='') && flt == ''){
    ...
    { */
        ...
        $.ajax({
            url: '/ProgressMonitoring/partialFrjvcDetails',
            data: {
                'land_type':1, //$("#drpfltype").val(),
                'selection': selection,
                'dist_id': dist_id,
                'div_id': div_id,
