                                                    ...
                                                    <div class="card-body custom-card-body">
                                                        ...
                                                        <div id="accordion2">
                                                        	 <div class="custom-control custom-checkbox checkbox-info ml-2 mr-2">
                                                                  ...
                                                                  <img src="http://103.112.26.243:8080/geoserver/FLI_DSS_Angul_vector/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&LAYER=FLI_DSS_Angul_vector:jv_certified_boundary" class="img-chk2" />                                                               
                                                             </div>
                                                             <div class="custom-control custom-checkbox checkbox-info ml-2 mr-2">
                                                                  ...
                                                                  <img src="http://103.112.26.243:8080/geoserver/FLI_DSS_Angul_vector/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&LAYER=FLI_DSS_Angul_vector:dgps_final_boundary" class="img-chk2" />                                                                 
                                                             </div>
                                                             <div class="custom-control custom-checkbox checkbox-info ml-2 mr-2">
                                                                  ...
                                                                  <label >Propose Pillar <img src="/assets/img/dot-blue.png"></label> 
                                                                  </div>                                                    
                                                             </div>
                                                            <div class="custom-control custom-checkbox checkbox-info ml-2 mr-2">
	    ...
	    dgpspillarLayer = new ol.layer.Vector({
	        ...
	        style:function(feature, resolution){
	            ...
	            var virtualStyle=new ol.style.Style({
	                    ...
	                    radius: 5,
	                    fillOpacity: 0.4,
	                    fill: new ol.style.Fill({color: '#fc0303'}),
	                    stroke: new ol.style.Stroke({
	                    color: '#fc0303', width: 1
	                    })
	                    }),
	                    text: new ol.style.Text({
	                    font: 'bold 12px Calibri,sans-serif',
