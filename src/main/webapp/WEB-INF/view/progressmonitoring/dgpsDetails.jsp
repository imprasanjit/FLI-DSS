					...
					<div class="widget-content widget-content-area">
						...
						<form >
							...
							<div class="text-center" style="margin-top:27px">
								...
								<button type="button" id="btnSearch" class="btn btn-success" >Show</button>
							</div>
...
<!-- Modal -->
                                   ...
                                   <tr id="faqs-row0">
                                       <td width="40%">
                                           ...
                                           <select id="ddlQbFields1" class="form-control form-control-sm">
                                           	   ...
                                           	   <option value="dgpsdha">DGPS Area(Ha.)</option>
                                           </select>
                                       </td>
                                       <td width="30%">
 ...
 <script type="text/javascript">
  ...
  $(document).ready(function() {
		// 	 setSelectedtext();
	  $("#tehDiv").hide();
	  $(".header-title-lg").text("ODISHA FLI-DSS (DGPS Details)");
 	});
...
if ((div == '' || dst=='') && flt == ''){
    ...
    { */
        ...
        $.ajax({
            url: '/ProgressMonitoring/partialDgpsDetails',
            data: {
