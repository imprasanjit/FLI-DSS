...
public interface AutoUserInfoRepository extends JpaRepository<AutoUserInfoMaster, Integer> {
	...
	//	@Query(value = "select * from public.auto_user_info_master where int_fk_role= :roleId and int_fk_position= :positionId", nativeQuery = true)
	//	List<AutoUserInfoMaster> findRolePositionWiseUserList(int roleId, int positionId);
