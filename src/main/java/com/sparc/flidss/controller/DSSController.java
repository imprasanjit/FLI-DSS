...
import com.sparc.flidss.viewmodel.GeomRequest;
...
//	System.out.println("user:"+ listPermisson);
	 ...
	 * @CDate 21 OCt 2021
	 */
	@RequestMapping(value = "/getAOIGeom", method = RequestMethod.POST)
	public @ResponseBody String LoadAOI(Model model, @RequestBody GeomRequest geomRqt) throws JsonProcessingException {
		try {
		         String aoiData="";
		         
				 List<AOIViewModel> aoiList = frlservice.getAOI(geomRqt.getGeom(),geomRqt.getBgeom());
	 ...
	 * @CDate 28 OCt 2021
	 */
	@RequestMapping(value = "/getAOIAnalysis", method = RequestMethod.POST)//@RequestParam(required = false) String geom,@RequestParam(required = false) String bgeom
	@ResponseBody
	public String LoadAOIAnalysis(@RequestBody GeomRequest geomRqt) throws JsonProcessingException {
		try {
		         String aoiAnalysisData="";
		         
				 List<AOIAnalysisViewModel> aoiAnalysisList = frlservice.getAOIAnalysis(geomRqt.getGeom(),geomRqt.getBgeom());																	 
